...
def create_transactions_db(
    ...
    conn.commit()
    conn.close()
    print(f"SQLite database '{db_name}' created with a single 'transactions' table.")


def get_schema(db_path: str) -> str:
    """Return the schema for the 'transactions' table."""
...
def print_html(content: Any, title: str | None = None, is_image: bool = False):
    ...
    - Otherwise: show as code/text in <pre><code>.
    """
