...
def main():
    ...
    rag_response += (
        f"I'd highly recommend the {rag_results[0]['food_name']} - "
        f"it's a {rag_results[0]['similarity_score']*100:.0f}% match "
        f"and offers that sweet, rich flavor you're craving. "
    )
